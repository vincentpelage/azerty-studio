...
const TypeWriterStyled = styled.svg`
  width: 220px;
  height: 160px;
  position: absolute;
  bottom: 1rem;
...
const TypeWriter = () => {
  return (
    ...
    >
      ...
      <ellipse cx="180.47" cy="642.47" rx="67.3" ry="12.94" fill="#00bec5" />
      ...
      <rect
        ...
        opacity="0.1"
      />
      <ellipse cx="275.91" cy="461.74" rx="15.31" ry="12.81" fill="#00bec5" />
      <ellipse cx="275.91" cy="461.74" rx="15.31" ry="12.81" opacity="0.1" />
      <ellipse cx="275.91" cy="458.93" rx="15.31" ry="12.81" fill="#00bec5" />
      ...
      <ellipse cx="736.71" cy="461.74" rx="15.31" ry="12.81" fill="#00bec5" />
      <ellipse cx="736.71" cy="461.74" rx="15.31" ry="12.81" opacity="0.1" />
      <ellipse cx="736.71" cy="458.93" rx="15.31" ry="12.81" fill="#00bec5" />
      <rect
        x="275.91"
        y="625.77"
        width="467.68"
      ...
      <polygon
        ...
        opacity="0.03"
      />
      <ellipse cx="847.47" cy="692.13" rx="33.8" ry="6.5" fill="#00bec5" />
