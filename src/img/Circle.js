...
const Circle = () => {
  return (
    ...
    >
      ...
      <ellipse cx="255" cy="565.57" rx="40.92" ry="7.87" fill="#6772e5" />
      ...
      <path
        ...
        opacity="0.1"
      />
      <ellipse cx="940" cy="638.57" rx="40.92" ry="7.87" fill="#6772e5" />
      ...
      <path
        ...
        opacity="0.1"
      />
      <circle cx="404.43" cy="93.69" r="15.27" fill="#6772e5" opacity="0.1" />
      <circle cx="459.06" cy="25.6" r="25.6" fill="#6772e5" opacity="0.1" />
      <circle cx="425.18" cy="149.82" r="25.6" fill="#6772e5" opacity="0.1" />
      <circle cx="963.93" cy="277.69" r="15.27" fill="#6772e5" opacity="0.1" />
      <circle cx="909.29" cy="209.6" r="25.6" fill="#6772e5" opacity="0.1" />
      <circle cx="943.18" cy="333.82" r="25.6" fill="#6772e5" opacity="0.1" />
      <circle cx="100.77" cy="305.35" r="8.65" fill="#6772e5" opacity="0.1" />
      <circle cx="137.85" cy="272.61" r="14.5" fill="#6772e5" opacity="0.1" />
      <circle cx="68.45" cy="295.1" r="14.5" fill="#6772e5" opacity="0.1" />
      <circle cx="741.77" cy="253.35" r="8.65" fill="#6772e5" opacity="0.1" />
      <circle cx="778.85" cy="220.61" r="14.5" fill="#6772e5" opacity="0.1" />
      <circle cx="709.45" cy="243.1" r="14.5" fill="#6772e5" opacity="0.1" />
      <circle cx="216.58" cy="142.32" r="36.25" fill="#6772e5" opacity="0.1" />
      <circle cx="423.58" cy="262.32" r="20.92" fill="#6772e5" opacity="0.1" />
      <circle cx="630.58" cy="398.32" r="20.92" fill="#6772e5" opacity="0.1" />
      <ellipse
        cx="255"
        cy="568.57"
        rx="119.5"
