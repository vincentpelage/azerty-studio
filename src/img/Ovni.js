...
const OvniStyled = styled.svg`
  ...
  .animate-ghost {
    animation: ${AnimateGhost} 5s cubic-bezier(0.46, 0.03, 0.52, 0.96) infinite;
  }
`;
...
const Ovni = () => (
  ...
  >
    ...
    <ellipse cx="432" cy="132.31" rx="143.21" ry="110.94" fill="#00989e" />
    <path
    ...
    <path
      ...
      className="animate-stars"
    />
    <g opacity="0.5" className="animate-stars">
